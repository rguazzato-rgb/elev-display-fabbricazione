...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const galleryData = {
        ...
        components: [
            ...
            { src: 'images/parts/tappo.png', label: 'S_06 — Tappo in PLA' },
        ...
        if (weightCtx) {
            ...
            new Chart(weightCtx, {
                ...
                data: { labels: comps, datasets: [
                    { label: 'Peso Grezzo (kg)', data: [12.83, 21.71, 9.69, 1.13, 0.061, 0.030, 0.030, 0.011], backgroundColor: 'rgba(201,169,110,.6)', borderColor: '#c9a96e', borderWidth: 1, borderRadius: 6 },
                    { label: 'Peso Finito (kg)', data: [4.97, 9.48, 4.00, 1.08, 0.061, 0.030, 0.030, 0.011], backgroundColor: 'rgba(107,168,255,.6)', borderColor: '#6ba8ff', borderWidth: 1, borderRadius: 6 }
                ] },
